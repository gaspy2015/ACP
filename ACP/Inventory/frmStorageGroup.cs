...
namespace ACP
{
    public partial class frmStorageGroup : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            if (Id.button == "CREATE")
            {
                ...
                else
                {
                    ...
                    {
                        //pc.modifyProduct("CRUD", "STORAGEDMNSN", pc.autoIncrementID("sdGroupID", "storageDmnsnGroup").ToString(), description, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
                        storageDmnsnGroup();
                        txtDesc.Clear();
            ...
            else if (Id.button == "UPDATE")
            {
                ...
                else
                {
                    ...
                    {
                        description = char.ToUpper(description[0]) + description.Substring(1);
                        //pc.modifyProduct("CRUD", "STORAGEDMNSN", Id.globalID, description, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
                        storageDmnsnGroup();
                        txtDesc.Clear();
        ...
        private void btDelete_Click(object sender, EventArgs e)
        {
            if (dgvStorageDmnsn.SelectedRows.Count > 0)
            {
                //pc.modifyProduct("DELETE", "STORAGEDMNSN", Id.globalID, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
                storageDmnsnGroup();
                btnCreate.Enabled = false;
                txtDesc.Clear();
            }
        ...
        private void dgvStorageDmnsn_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            dgvStorageDmnsn.ClearSelection();
        }
    }
}
